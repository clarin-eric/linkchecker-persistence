...
class StatusRepositoryTests extends RepositoryTests {
    ...
    void findAggregatedStatus(){
        ...
        assertEquals(3, sRep.findAggregatedStatus().count());

        sRep.findAggregatedStatus()
                .filter(aggregatedStatus -> aggregatedStatus.getCategory().equals(Category.Ok) && aggregatedStatus.getProvidergroupName().equals("pg1"))
                    .findFirst().ifPresent(aggregatedStatus -> {
                        ...
                        assertEquals(10, aggregatedStatus.getNumberId());
                        assertEquals(10, aggregatedStatus.getNumberDuration());
                });
        ...
        sRep.findAggregatedStatus()
                ...
                .findFirst().ifPresent(aggregatedStatus -> {
                    assertEquals(10, aggregatedStatus.getNumberId());
                    assertEquals(5, aggregatedStatus.getNumberDuration());
                });
    }
}
